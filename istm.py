import os.path                                   
file = 'static/assets/img/1_up.png'    
...
if os.path.isfile(file):
  ...
  model = tf.keras.models.load_model('battery/static/assets/simple_model.h5')
  ...
  plt.legend()
  fig = plt.gcf()
  fig.savefig('static/assets/img/1_up.png')
  plt.close()
  ...
  plt.legend()
  fig = plt.gcf()
  fig.savefig('battery/static/assets/img/1_down.png')
  plt.close()
